...
if(trim($email_sub) == '') 	{echo '<div class="error_message">Please enter a valid email address.</div>';exit();}
else if(!isEmail($email_sub)) 		{echo '<div class="error_message">Attention! This is invalid E-mail Address. Please try again.</div>';exit();}
...
$toaddress = "connect@myfintrans.com";  //projects2vk@gmail.com 

$e_subject = 'Newsletter Subscription By ' . $email_sub . '.';

$message = '<!DOCTYPE HTML>
	<html>
	<head>Newsletter Subscribed By</head>
	<body>
	<table>
	   
		<tr><td>Email:</td><td>' . $email_sub . '</td></tr>
		
	</table>
	</body>
	</html>';
$headers = "From: $email_sub" . PHP_EOL;
$headers .= "Reply-To: $email_sub" . PHP_EOL;
